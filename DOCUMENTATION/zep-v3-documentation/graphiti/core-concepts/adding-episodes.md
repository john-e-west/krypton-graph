...
**Source URL:** https://help.getzep.com/v3/graphiti/core-concepts/adding-episodes  
**Scraped:** 2025-08-29 13:02:03

---

##### 

Refer to the [Custom Entity Types](/v3/graphiti/core-concepts/custom-entity-and-edge-types) page for detailed instructions on adding user-defined ontology to your graph.
...
The graph below was generated using the code in the [Quick Start](/v3/graphiti/getting-started/quick-start). Each **podcast** is an individual episode.
